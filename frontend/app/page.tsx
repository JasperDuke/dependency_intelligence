    ...
    <>
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', py: { xs: 7, md: 11 } }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'minmax(0, 1.12fr) minmax(320px, 0.88fr)' }, gap: { xs: 5, md: 8 }, alignItems: 'center' }}>
            <Box>
              <Chip
            ...
            <Box sx={{ position: 'relative', mx: { xs: 'auto', md: 0 }, width: '100%', maxWidth: 430 }}>
              ...
              <Box sx={{ position: 'relative', p: { xs: 2, sm: 2.5 }, borderRadius: 4, bgcolor: 'rgba(24, 25, 35, 0.82)', border: '1px solid rgba(179, 157, 219, 0.25)', boxShadow: '0 24px 70px rgba(0,0,0,0.3)', backdropFilter: 'blur(18px)' }}>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 5, md: 7 } }}>
        <Box component="section" aria-label="Product capabilities" sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, border: '1px solid', borderColor: 'divider', borderRadius: 3, overflow: 'hidden', bgcolor: 'rgba(255,255,255,0.015)' }}>
